		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<form class="form-horizontal" method="post" action="{{url('course')}}">
					{{csrf_field()}}
					<div class="panel-heading"><h3 align="center">Cadastro de Cursos</h3></div>
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<div class="input-group">
									...
									<input id="nome" name="nome" required="required" type="text" placeholder="Nome do Curso" class="form-control input-md">
								</div>
							</div>
						</div>
